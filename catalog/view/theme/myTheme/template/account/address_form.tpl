...
<div class="container">
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="col-md-10  col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1 edit-address <?php echo $class; ?>"> <?php echo $content_top; ?>
      <h2 class="login-title"><?php echo $text_edit_address; ?></h2>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons clearfix">
          <div class="pull-left"><a href="<?php echo $back; ?>" class="btn btn-register"><?php echo $button_back; ?></a></div>
          <div class="pull-right">
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-register" />
          </div>
        </div>
      </form>
