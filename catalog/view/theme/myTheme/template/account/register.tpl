...
<div class="container">
  ...
  <?php } ?>
  <div class="row">
    <div id="content" class="col-md-8  col-sm-8 col-xs-12 col-md-offset-2 col-sm-offset-2 <?php echo $class; ?> registration-form"><?php echo $content_top; ?>
      <h1 class="register-title"><?php echo $heading_title; ?></h1>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="buttons" style="text-align: center">
          <div class=""><?php echo $text_agree; ?>
            ...
            <?php } ?>
            &nbsp;<br/>
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn-register" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons" style="text-align: center">
