...
<?php $i=0; foreach ($latest_blogs as $blog) { ?>
  <div class="col-sm-6" style="border-top: 3px solid #3FADBC; padding: 30px 0px; overflow: hidden">
...
<?php $i++; } ?>
<?php if ($i/2 != 0) { ?>
  <div class="col-sm-6" style="border-top: 3px solid #3FADBC; padding: 30px 0px; overflow: hidden"></div>
<?php } ?>
<div class="col-sm-12" style="border-top: 3px solid #3FADBC"></div>
</div>
</div>
