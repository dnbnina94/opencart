...
<header>
  <div class="container logo_container">
    <div class="row logo_container_row">
      <div class="col-sm-4">
        <div id="logo">
          <?php if ($logo) { ?>
      ...
      <div class="col-sm-8">
        <div class="row">
          <div class="col-sm-5"><?php echo $manufacturers; ?>
          </div>
          <div class="col-sm-5"><?php echo $search; ?>
          </div>
          <div class="col-sm-2" style="padding: 0px"><?php echo $cart; ?></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <nav id="menu" class="navbar">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" style="text-transform: uppercase"><a href="<?php echo $category['href']; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $category['name']; ?></a>
        ...
        <?php } else { ?>
        <li style="text-transform: uppercase"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
        <?php } ?>
        <?php } ?>
      </ul>
    </div>
