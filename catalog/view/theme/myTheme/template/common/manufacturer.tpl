	...
	<div class="manufacturers-dropdown">
		<div class="manufacturers-dropdown-box">
			<?php foreach ($manufacturers_all as $man) { ?>
  				<a href="http://localhost/opencart/index.php?route=product/manufacturer/info&manufacturer_id=<?php echo $man['manufacturer_id']; ?>" class="manufacturer_link"><div class="manufacturer-name-wrapper"><?php echo $man['name']; ?></div></a>
  			<?php } ?>
		</div>
  </div>
</div>
