...
class ModelCatalogProduct extends Model
{
    ...
    public function getBestSellerProductsOfManufacturers($limit, $manufacturer)
    {
        $query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product WHERE manufacturer_id = " . $manufacturer . " GROUP BY product_id ORDER BY shipping DESC LIMIT " . (int)$limit);
