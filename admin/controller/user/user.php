...
class ControllerUserUser extends Controller
{
    ...
    protected function getList()
    {
        ...
        if ($this->session->data['user_id'] != 1) {
            $results = $this->model_user_user->getOneUser($filter_data, $this->session->data['user_id']);
        } else {
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['short_description'])) {
            ...
            $data['short_description'] = $user_info['short_description'];
        } else {
    ...
    protected function validateForm()
    {
        ...
        if ((utf8_strlen(trim($this->request->post['short_description'])) < 1) || (utf8_strlen(trim($this->request->post['short_description'])) > 32)) {
            $this->error['short_description'] = $this->language->get('error_short_description');
        }
        if ((utf8_strlen(trim($this->request->post['description'])) < 1) || (utf8_strlen(trim($this->request->post['description'])) > 1080)) {
