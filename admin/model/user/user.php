...
class ModelUserUser extends Model {
    ...
    public function getOneUser ($data = array(), $user_id) {
    ...
    public function getOurEditors ($user_id) {
        $sql = "SELECT * FROM `" . DB_PREFIX . "user` WHERE user_group_id = 11 AND user_id = $user_id";
