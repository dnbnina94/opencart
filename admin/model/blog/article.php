...
class ModelBlogArticle extends Model
{
    ...
    public function getSingleArticle($data = array(), $user_id)
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "easy_blog_article a LEFT JOIN " . DB_PREFIX . "easy_blog_article_description ad ON (a.article_id = ad.article_id) WHERE ad.author_id = $user_id AND ad.language_id = '" . (int)$this->config->get('config_language_id') . "'";
