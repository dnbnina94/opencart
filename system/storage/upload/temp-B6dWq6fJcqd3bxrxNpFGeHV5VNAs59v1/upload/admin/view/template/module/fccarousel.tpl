	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><strong><i class="fa fa-pencil"></i> <?php echo $text_edit; ?></strong></h3>
			</div>
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-fpcarousel" class="form-horizontal">
					<div class="row">
						<div class="col-sm-6">	
							...
							<div class="row">
								...
								<label class="control-label" for="input-category">
									<span data-toggle="tooltip" title="" data-original-title="<?php echo $help_categories; ?>"><?php echo $entry_categories; ?></span>
								</label>
								  <input id="input-category" class="form-control" type="text" name="category" value="" placeholder="<?php echo $entry_categories; ?>" />
						...
						<div class="col-sm-6">
							...
							<div class="row">		  
								<div class="col-sm-6">
									<label class="control-label" for="input-itemspage-lg"><?php echo $entry_itemspage; ?> (lg)</label>
									<input id="input-itemspage-lg" class="form-control" type="text" name="itemspage_lg" value="<?php echo $itemspage_lg; ?>" size="3" />				
								</div>
								<div class="col-sm-6">
									<label class="control-label" for="input-itemspage-md"><?php echo $entry_itemspage; ?> (md)</label>
									<input id="input-itemspage-md" class="form-control" type="text" name="itemspage_md" value="<?php echo $itemspage_md; ?>" size="3" />			
								</div>		  
							</div>							
							<div class="row">		  
								<div class="col-sm-6">
									<label class="control-label" for="input-itemspage-sm"><?php echo $entry_itemspage; ?> (sm)</label>
									<input id="input-itemspage-sm" class="form-control" type="text" name="itemspage_sm" value="<?php echo $itemspage_sm; ?>" size="3" />				
								</div>
								<div class="col-sm-6">
									<label class="control-label" for="input-itemspage-xs"><?php echo $entry_itemspage; ?> (xs)</label>
									<input id="input-itemspage-xs" class="form-control" type="text" name="itemspage_xs" value="<?php echo $itemspage_xs; ?>" size="3" />			
								</div>		  
							</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<label class="control-label" for="input-pagination_numbers">
										<span data-toggle="tooltip" title="" data-original-title="<?php echo $help_pagination_numbers; ?>"><?php echo $entry_pagination_numbers; ?></span>
									</label>
									<select id="input-pagination_numbers" class="form-control" name="pagination_numbers">
										<?php if ($pagination_numbers) { ?>
										<option value="1" selected="selected"><?php echo $text_yes; ?></option>
										<option value="0"><?php echo $text_no; ?></option>
										<?php } else { ?>
										<option value="1"><?php echo $text_yes; ?></option>
								...
								<div class="col-sm-6">
									<label class="control-label">
										<span data-toggle="tooltip" title="" data-original-title="<?php echo $help_scroll_per_page; ?>"><?php echo $entry_scroll_per_page; ?></span>
									</label>
									<select id="input-scroll_per_page" class="form-control" name="scroll_per_page" >
										<?php if ($scroll_per_page) { ?>
										<option value="1" selected="selected"><?php echo $text_yes; ?></option>
										<option value="0"><?php echo $text_no; ?></option>
										<?php } else { ?>
										<option value="1"><?php echo $text_yes; ?></option>
            ...
            <div class="panel-footer">
                <div class="text-right">
                    <button type="submit" form="form-fpcarousel" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"><strong><i class="fa fa-thumbs-o-up"></i> <?php echo $credits_rating_head; ?></strong></h4>
                    </div>
                    <div class="panel-body">
                        <p><?php echo $credits_rating_text; ?> <a href="http://www.opencart.com/index.php?route=extension/extension/info&extension_id=22956" target="_blank">http://www.opencart.com/index.php?route=extension/extension/info&extension_id=22956</a></p>
                        <p><?php echo $credits_rating_moti; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"><strong><i class="fa fa-money"></i> <?php echo $credits_donate_head; ?></strong></h4>
                    </div>
                    <div class="panel-body">
                        <p><?php echo $credits_donate_text; ?></p>
                    </div>
                </div> 
            </div>
        </div>
